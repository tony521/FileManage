"""
Django settings for webdrive project.
...
SECRET_KEY = '4rv%r+5=jzznx1$anvv-vn315o%pmt!nqm)mcevn!+jt+dik(4'
...
WSGI_APPLICATION = 'webdrive.wsgi.application'
